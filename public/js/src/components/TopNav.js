    ...
    return(
        ...
        <li className="dropdown">
            ...
            <ul className="dropdown-menu message-dropdown">
                <MessagePreview message={"Wow today is going to be a great day!"} name={"Lou Dog"}/>
        ...
        <li className="dropdown">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown"><i className="fa fa-user"></i> Collin Betori <b className="caret"></b></a>
